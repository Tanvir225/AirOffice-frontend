...
const TopupLedger = () => {
    ...
    return (
        <div className="p-5 space-y-6 bg-white rounded border h-[95vh] overflow-y-auto">
            ...
            <div className="border-b pt-4 flex justify-between font-semibold text-lg">
                <span>Total Credit: <span className="text-green-700">{totalCredit}</span></span>
                <span>Total Debit: <span className="text-red-600">{totalDebit}</span></span>
                <span>Balance: <span className="text-blue-700">{balance}</span></span>
            </div>
